...
## Development Setup Extras

1. I had a hard time using flask migrate so I had to switch to flask_script and used the Manager to handle the migrations instead.
   ->>While running python migrate should you run in to this error specificly
   **\* ModuleNotFoundError: No module named 'flask.\_compat'
   ->>Then go to flask_script/init.py
   then change ** from .\_compat import text_type
   to this \*\* from flask_script.\_compat import text_type
2. I have updated the requirement.txt file.
